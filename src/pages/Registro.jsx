  ...
  return (
    ...
    <h1 class="h3 fw-normal text-white dark-mode">Cargar Usuario</h1>
     ...
     <div class="form-floating  ">
            <select class="form-select form-select mb-3 rol" aria-label="Large select example" id="rol" required>
                <option disabled selected value="">Rol de Usuario</option>
                <option  class="rol">Rol</option>
            </select>
            <label for="rol">Seleccione Rol</label>
        </div>
    </div>
    <div class="form-floating mb-3">
      <input type="number" class="form-control" id="dni" placeholder=" ej: 11223344"  autofocus="autofocus"/>
      <label for="dni">Ingrese DNI</label>
    </div>
    <div class="d-flex gap-2 ">
    <div class="form-floating mb-3 w-50">
    <input type="text" class="form-control" id="nombre" placeholder=" ej: Juan"  autofocus="autofocus"/>
      <label for="nombre">Ingrese nombre</label>
    </div>
    <div class="form-floating mb-3 w-50">
    <input type="text" class="form-control" id="apellido"  placeholder=" ej: Perez"  autofocus="autofocus"/>
      <label for="apellido">Ingrese apellido</label>
    </div>
        </div>
    <div class="form-floating mb-3">
     <input type="email" class="form-control" id="email" placeholder=" ej: juan@perez.com"  autofocus="autofocus"/>
      <label for="email">Ingrese e-mail</label>
    </div>
     <div class="form-floating mb-3">
    <input type="number" class="form-control" id="cel"  placeholder=" ej: 11223344"  autofocus="autofocus"/>
      <label for="cel">Ingrese su celular</label>
    </div>
      <div class="d-flex gap-2 ">
    <div class="form-floating mb-3 w-50">
     <input type="password" class="form-control" id="contra" placeholder=" su contraseña"  autofocus="autofocus"/>
