  ...
  return (
    ...
    <div className="form-floating mb-3">
     <input type="email" className="form-control" name='email' value={formData.email} onChange={handleChange} id="email" placeholder=" ej: juan@perez.com"  autoFocus="autoFocus"/>
      ...
      <div className="d-flex gap-2 ">
    <div className="form-floating mb-3 w-50">
     <input type={showPassword ? "text" : "password"} className="form-control" name="contra" id="contra" value={formData.contra} onChange={handleChange} placeholder=" su contraseña"  autoFocus="autoFocus"/>
      ...
      <div className="form-floating mb-3 w-50">
     <input type={showPasswordRepeat ? "text" : "password"} className="form-control" id="contra2" value={contra2} onChange={handlePasswordChange} placeholder=" su contraseña" />
      ...
      <button
                ...
                >
                  {showPasswordRepeat ?  <img src={EyeClosed} alt="" /> :  <img src={EyeOpen} alt="" />}
                </button>
    </div>
      </div>
      {passwordError && (
      ...
      {error != null ?<div  className="d-flex align-items-center alert alert-danger alert-dismissible fade show py-2" role="alert">
