  ...
  return (
    <main className="mt-5 p-5 col-lg-6 m-auto">
      <form className="" action="/registro" method="post">
        ...
        <div className="form-floating mb-3">
          <input type="text" className="form-control" id="empresa" placeholder="Ej: Empresa S.A." required />
          <label htmlFor="empresa">Ingrese empresa</label>
        </div>
        <div className="form-floating mb-3">
          <input type="text" className="form-control" id="prestadorMedico" placeholder="Ej: Galeno" required />
